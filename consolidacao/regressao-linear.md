...
![Gráfico de dispersão entre a média sem Matemática e a nota de Matemática](../imagens/regressao-media-mt.png)
...
![Gráfico de resíduos](../imagens/residuos-regressao.png)
...
![Visualização dos resíduos dos 15 primeiros participantes](../imagens/residuos-15.png)
